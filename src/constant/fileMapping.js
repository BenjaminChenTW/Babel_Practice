...
const files = {
  ...
  subzoology: {
    name: 'subzoology',
    title: '禽獸不如－2020台灣美術雙年展 Subzoology: 2020 Taiwan Biennial',
    artist_name: '國立臺灣美術館',
    artist: filesNameCreator('artist', 'subzoology', 8),
    creation: filesNameCreator(
      'creation',
      'subzoology',
      155,
    ...
    curator: filesNameCreator('curator', 'subzoology'),
    kv: filesNameCreator('kv', 'subzoology'),
    kv_info: filesNameCreator('kv_info', 'subzoology'),
    kv_all: filesNameCreator('kv_all', 'subzoology'),
    kv_description: filesNameCreator('kv_description', 'subzoology'),
    main: filesNameCreator('main', 'subzoology'),
    banner: filesNameCreator('banner', 'subzoology'),
    youtube: filesNameCreator('youtube', 'subzoology'),
